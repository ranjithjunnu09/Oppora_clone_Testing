...
export const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        "rounded-xl border border-[var(--color-border)] bg-surface shadow-sm transition-colors",
        className,
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <p ref={ref} className={cn("text-xs leading-relaxed text-fg-muted", className)} {...props} />
));
